...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(DiaryReviewDao.class);
        registerDaoClass(EncourageSentenceDao.class);
        registerDaoClass(ImportDateDao.class);
        registerDaoClass(ScheduleTodoDao.class);
        registerDaoClass(TargetDao.class);
        registerDaoClass(TomatoTodoDao.class);
        registerDaoClass(UpTempletDao.class);
