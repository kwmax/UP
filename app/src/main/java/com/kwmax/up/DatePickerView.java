...
public class DatePickerView extends View {
    ...
    private void init() {
        ...
        mPaint.setColor(ContextCompat.getColor(context, R.color.daterange_picker_selected));
        //第二个paint(未选中)
        nPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        //nPaint.setStyle(Style.FILL);
        nPaint.setTextAlign(Paint.Align.CENTER);
        nPaint.setColor(ContextCompat.getColor(context, R.color.daterange_picker_unselected));
    }
